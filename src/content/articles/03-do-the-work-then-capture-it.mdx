...
Your team reads LINQ as query syntax. Joins, filters, projections — they all use `from`, `where`, `orderby`, `select`. Method calls are reserved for terminal operations like `Take` and `ToListAsync`. You tell the assistant:
...
*Next: [Article 2 — Test Your Skill in a Clean Room](/articles/02-test-your-skill-in-a-clean-room)*
